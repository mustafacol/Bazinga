! function(t, e) {
    ...
    function l(t) {
        ...
        var e = s(t),
            ...
            i = e.overflowX,
            r = e.overflowY;
        return /(auto|scroll)/.test(n + r + i) ? t : l(a(t))
    }
    ...
    function p(t, e, n, i) {
        return Math.max(e["offset" + t], e["scroll" + t], n["client" + t], n["offset" + t], n["scroll" + t], bt() ? n["offset" + t] + i["margin" + ("Height" === t ? "Top" : "Left")] + i["margin" + ("Height" === t ? "Bottom" : "Right")] : 0)
    }

    function g() {
        var t = document.body,
            e = document.documentElement,
            n = bt() && getComputedStyle(e);
        return {
    ...
    function E(t, e, n, i) {
        var r, o, c, h, d, p, _, E = {
            ...
            b = f(t, e);
        if ("viewport" === i) o = (r = b).ownerDocument.documentElement, c = v(r, o), h = Math.max(o.clientWidth, window.innerWidth || 0), d = Math.max(o.clientHeight, window.innerHeight || 0), p = u(o), _ = u(o, "left"), E = m({
            ...
            var y = void 0;
            "scrollParent" === i ? "BODY" === (y = l(a(e))).nodeName && (y = t.ownerDocument.documentElement) : y = "window" === i ? t.ownerDocument.documentElement : i;
            var T = v(y, b);
    ...
    for (var H, M, W, U, B, F, K, V, Q, Y, G, q, z, X, Z, J, $, tt, et, nt, it, rt, ot, st, at, lt, ct = function(t) {
            ...
            return e.toggle = function() {
                ...
                if (n) {
                    var i = G(this._element).find("input")[0];
                    if (i) {
                        if ("radio" === i.type)
            ...
            t.preventDefault();
            var e = t.target;
            G(e).hasClass("btn") || (e = G(e).closest(st)), lt._jQueryInterface.call(G(e), "toggle")
                ...
                arrow: {
                    ...
                    fn: function(t, e) {
                        ...
                        var _ = l[u] + l[h] / 2 - g / 2,
                            ...
                            y = _ - t.offsets.popper[u] - E - b;
                        return y = Math.max(Math.min(a[h] - g, y), 0), t.arrowElement = i, t.offsets.arrow = (Ct(n = {}, u, Math.round(y)), Ct(n, d, ""), n), t
                    },
                    element: "[x-arrow]"
                },
                flip: {
                    ...
                    fn: function(t, e) {
                        ...
                        return s.forEach(function(a, l) {
                            ...
                            var c, h = t.offsets.popper,
                                ...
                                b = !!e.flipVariations && (E && "start" === o && p || E && "end" === o && g || !E && "start" === o && m || !E && "end" === o && _);
                            (d || v || b) && (t.flipped = !0, (d || v) && (i = s[l + 1]), b && (o = "end" === (c = o) ? "start" : "start" === c ? "end" : c), t.placement = i + (o ? "-" + o : ""), t.offsets.popper = wt({}, t.offsets.popper, w(t.instance.popper, t.offsets.reference, t.placement)), t = A(t.instance.modifiers, t, "flip"))
                        }), t
                    },
                    behavior: "flip",
                    padding: 5,
